    ...
    <div class="layout">
        <div class="container basic-margin basic-width">
            ...
            <div class="bg-white p-3" style="border-radius: 0.5rem">
                <h2 class="text-center bg-white">Create New Contact</h2>
                <form action="{{ route('contact.store') }}" method="POST" class="form-control bg-white">
                    @csrf
                    ...
                    <div class="form-group bg-white mb-2">
                        ...
                        <input type="text" name="email" id="email" class="form-control bg-white" required>
                    </div>
                    <div class="form-group bg-white mb-2">
                    ...
                    <div class="form-group bg-white mb-2">
                        ...
                        <textarea name="address" id="address" class="form-control text-justify" cols="30" rows="3"></textarea>
                    </div>
